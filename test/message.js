...
describe('Message', function() {
  ...
  var badAddress = 'y2tWRDRjLzfVUPDCB5hp9mkU7BHUoeZr41';
  var privateKey = npwcore.PrivateKey.fromWIF('cPBn5A4ikZvBTQ8D7NnvHZYCAxzDZ5Z2TSGW2LkyPiLxqYaJPBW4');
  var text = 'hello, world';
  var signatureString = 'IHVqgYCKFKoo0O42k/HhHTirydhJyqtKKRnmY4MRLroFL95z3LYdawyTVmYZEgrkjtwBisPloiJCUaYwobCcKU4=';
  ...
  it('will verify with an uncompressed pubkey', function() {
    var privateKey = new npwcore.PrivateKey('88q6SwwUcto4aJg94DALiYJKhx7QbcQg5fo4vmo2XBiSdUQ6Szt');
